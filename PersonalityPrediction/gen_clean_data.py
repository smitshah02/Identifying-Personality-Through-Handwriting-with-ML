...
df = pd.read_csv('lists/raw_features.csv', header=None, names=["BASE_LINE_ANGLE", "TOP_MARGIN", "LINE_SPACING", "SLANT_ANGLE", "WORD_SPACING", "LETTER_SIZE", "file_name", "height", "width", "dpi" ])
